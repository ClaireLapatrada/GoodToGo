...
def detect_defects(models, input_images, file_path):
    ...
    for image in input_images:
        ...
        cv2.imwrite(os.path.join(file_path , image), original_image)

if __name__ == "__main__":
    # Define models and their corresponding class YAMLs
    models = {
        "model1": {
            "weights": "weights/holes.onnx",
            "classes": "clothingDefect.yaml"
        },
        "model2": {
            "weights": "weights/stainDetectorFR.onnx",
            "classes": "stains.yaml"
        }
    }
    ...
    detect_defects(model_dict, ["samples/hole.jpg"], "mac-yolo/samples" )
